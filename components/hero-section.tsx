    ...
    <section className="py-16 md:py-24">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            href="#features"
            className="inline-flex items-center justify-center px-6 py-3 border-2 border-blue-400 text-blue-400 rounded-lg font-medium hover:bg-blue-400/10 transition-colors"
          >
            Learn More
          </a>
        </div>
